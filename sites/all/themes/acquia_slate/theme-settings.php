...
function acquia_slate_settings($saved_settings) {
  ...
  // Branch Name
  $form['tnt_container']['general_settings']['branch_name'] = array(
    '#type' => 'fieldset',
    '#title' => t('Branch Name'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['branch_name']['branch_name_display'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display branch Name'),
    '#default_value' => $settings['branch_name_display'],
  );
  $form['tnt_container']['general_settings']['branch_name']['branch_name_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Name of Your Branch'),
    '#default_value' => $settings['branch_name_text'],
  );
 
  // Preamble
  $form['tnt_container']['general_settings']['preamble'] = array(
    '#type' => 'fieldset',
    '#title' => t('IWW Preamble'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['tnt_container']['general_settings']['preamble']['preamble_display'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display Preamble'),
    '#default_value' => $settings['preamble_display'],
  ); 
  $form['tnt_container']['general_settings']['preamble']['preamble_nid'] = array(
    '#type' => 'textfield',
    '#title' => t('Node ID of the Preamble'),
    '#default_value' => $settings['preamble_nid'],
  );
